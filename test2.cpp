...
*/
    ...
    TEST("1.13")
    ((((eurovision += Vote(vr1, "Cyprus")) += Vote(vr1, "Cyprus")) += Vote(vr1, "Cyprus")) += Vote(vr1,
                                                                                                   "Cyprus")) += Vote(
            vr1, "Cyprus");
    cout << eurovision << endl;
...
cout << p1.isRegistered() << endl;
    cout << p2.isRegistered() << endl;
    cout << p3.isRegistered() << endl;
    cout << p4.isRegistered() << endl;
